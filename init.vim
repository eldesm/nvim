...
source $HOME/workspace/nvim/settings.vim
source $HOME/workspace/nvim/mappings.vim
source $HOME/workspace/nvim/pluginstall.vim
"source $HOME/workspace/nvim/lsp-config.vim
